...
func Test_Command(t *testing.T) {
	...
	tests2 := lib.TestCases[A, string] {
		...
		{Name: "test #task> with args (predefined argument type)", TestArg: A{cmd: "mdtk eb taskarg2-test"}, 
		Expected: "hello / arg: task-arg\ntask-arg\n"},
		...
		{Name: "test #func> with args (predefined argument type)", TestArg: A{cmd: "mdtk eb funcarg2-test"}, 
		Expected: "hello / arg: func-arg\nfunc-arg\n"},
		{Name: "test #func> with args2: required type positional parameter is not set", TestArg: A{cmd: "mdtk eb funcarg3-test"}, 
		Expected: "$1: unbound variable"},
		{Name: "test #func> with args3: optional type positional parameter is not set", TestArg: A{cmd: "mdtk eb funcarg4-test"}, 
		Expected: "hello / arg: \n"},
...
func Test_CommandPwSh(t *testing.T) {
	...
	tests := lib.TestCases[A, string] {
		...
		Expected: "hello"},
		{Name: "test #task>", TestArg: A{cmd: "mdtk pseb task-test"}, 
		Expected: "hello"},
		{Name: "test #task> with args", TestArg: A{cmd: "mdtk pseb taskarg-test"}, 
		Expected: "hello / arg: task-arg"},
		{Name: "test #task> with args (predefined argument type)", TestArg: A{cmd: "mdtk pseb taskarg2-test"}, 
		Expected: "hello / arg: task-arg\ntask-arg\n"},
		{Name: "test #func>", TestArg: A{cmd: "mdtk pseb func-test"}, 
		Expected: "hello"},
		{Name: "test #func> with args", TestArg: A{cmd: "mdtk pseb funcarg-test"}, 
		Expected: "hello / arg: func-arg"},
		{Name: "test #func> with args (predefined argument type)", TestArg: A{cmd: "mdtk pseb funcarg2-test"}, 
		Expected: "hello / arg: func-arg\nfunc-arg\n"},
		{Name: "test #func> with args2: required type positional parameter is not set", TestArg: A{cmd: "mdtk pseb funcarg3-test"}, 
		Expected: "OperationStopped:"},
		{Name: "test #func> with args3: optional type positional parameter is not set", TestArg: A{cmd: "mdtk pseb funcarg4-test"}, 
		Expected: "hello / arg: \n"},
		{Name: "test #config> once (embed)", TestArg: A{cmd: "mdtk pseb once1-test"}, 
		Expected: "* first\nhello\n* second\nend\n"},
		{Name: "test #config> once (task)", TestArg: A{cmd: "mdtk pseb once2-test"}, 
		Expected: "* first\nhello\n* second\nhello\nend\n"},
		{Name: "test #config> once (func)", TestArg: A{cmd: "mdtk pseb once3-test"}, 
		Expected: "* first\nhello\n* second\nhello\nend\n"},
