...
func Test_TaskData(t *testing.T) {
	...
	t.Run("GetAttrsAndSet", func(t *testing.T) {
		tests := []struct {
			...
			{"ok", "[attr1 attr2 attr3] description", []string{"attr1", "attr2", "attr3"}, "description", "group", lang.ShellLangs},
			{"rest is trimed space", "[attr1 attr2 attr3]   description    ", []string{"attr1", "attr2", "attr3"}, "description", "group", lang.ShellLangs},
			{"no attrs", "description", []string{}, "description", "group", lang.ShellLangs},
			{"no attrs but has bracket", "[] description", []string{}, "description", "group", lang.ShellLangs},
			{"no description", "[attr1 attr2 attr3] ", []string{"attr1", "attr2", "attr3"}, "", "group", lang.ShellLangs},
			{"If it is not the front, it remains so.", "* [attr1 attr2 attr3] description", []string{}, "* [attr1 attr2 attr3] description", "group", lang.ShellLangs},
			{"private group has attr 'hidden'", "[attr1 attr2 attr3] description", []string{"attr1", "attr2", "attr3", "hidden"}, "description", "_group", lang.ShellLangs},
			{"no-shell lang has attr 'hidden'", "[attr1 attr2 attr3] description", []string{"attr1", "attr2", "attr3", "hidden"}, "description", "group", "go"},
		}

		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				td := TaskData{Description: []string{tt.accepted}, Group: group.Group(tt.group), Lang: lang.Lang(tt.lang)}
				td.GetAttrsAndSet()
